...
import numpy as np
import sys
sys.path.insert(0, "/Users/amirgavrieli/PycharmProjects/CS231n-CNN-AG/assignment3_2019")
...
class CaptioningRNN(object):
    ...
    def __init__(self, word_to_idx, input_dim=512, wordvec_dim=128,
        ...
        self.params['Wx'] = np.random.randn(wordvec_dim, dim_mul * hidden_dim)  # (V, dim_mul * H)
    ...
    def loss(self, features, captions):
        ...
        # (1)
        h0, cache_initial = affine_forward(features, W_proj, b_proj)  # (N, H)
        # (2)
        x, cache_word_embedding = word_embedding_forward(captions_in, W_embed)  # (N, T, W)
        # (3)
        ...
        ### Gradients ###
        dx_temp_affine, dw_temp_affine, db_temp_affine = temporal_affine_backward(dx, cache_temp_aff)
